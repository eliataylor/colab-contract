  ...
  return (
    <Box>
      ...
      <Box>
                  ...
                  <Box sx={{ display: 'flex', gap: 3, flexWrap: 'wrap' }}>
                    <Card variant="outlined" sx={{ flex: 1, minWidth: 300 }}>
                      <CardContent>
                        ...
                        <Typography variant="body2" paragraph>
                          A. To protect each Founder's brand ownership, Company IP and ensure they have final authority in the direction of the Company
                        </Typography>
                        <Typography variant="body2" paragraph>
                          B. To protect each Contributor's freedom to pursue other opportunities as a founder or contributor in other projects so long they honor all terms in this agreement.
                        </Typography>
                    ...
                    <Card variant="outlined" sx={{ flex: 1, minWidth: 300 }}>
                      <CardContent>
                        ...
                        <Typography variant="body2" paragraph>
                          A. To grant each Contributor a transparent path to earning minority equity holdings in the Company.
                        </Typography>
                        <Typography variant="body2">
                          B. To ensure everyone is reimbursed for unpaid time if the company is sold or starts to earn enough profit.
                        </Typography>
                      </CardContent>
                    </Card>
                  </Box>
              ...
              <AccordionDetails>
                <Box>
                  ...
                  <List>
                    ...
                    <ListItem>
                      <ListItemText primary="• Trade secrets related to business strategies, financial information, and customer data." />
                    </ListItem>
                  </List>
                  
                  <Alert severity="info" sx={{ my: 2 }}>
                    <Typography variant="body2">
                      <strong>Excluded:</strong> This definition expressly excludes the Contributors' general skills, experience, and knowledge, as well as general software code, algorithms, and development methodologies that are not proprietary to the Company's core IP.
                    </Typography>
                  </Alert>
                  ...
                  <Typography variant="body1" paragraph>
                    To protect the relationships we've built, the Contributor agrees that for a period of <strong>twelve (12) months</strong> following their departure from the Company, they will not, either directly or indirectly:
                  </Typography>
                  <List>
                    <ListItem>
                      <ListItemText primary="• Solicit, entice, or persuade any employee or independent contractor of the Company to leave their employment or engagement." />
                    </ListItem>
                    <ListItem>
                      <ListItemText primary="• Solicit any customer of the Company with whom they had direct contact during their engagement, for the purpose of providing services or products that are competitive with the Company's business." />
                    </ListItem>
                  </List>
            ...
            {/* Compensations */}
            <Accordion expanded={expanded === 'compensations'} onChange={handleChange('compensations')}>
              <AccordionSummary expandIcon={<ExpandMore />}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                  <AttachMoney color="primary" />
                  <Typography variant="h6">2. Compensations</Typography>
                </Box>
              </AccordionSummary>
              <AccordionDetails>
                <Typography variant="body1" paragraph>
            ...
            <Accordion expanded={expanded === 'vesting'} onChange={handleChange('vesting')}>
              ...
              <AccordionDetails>
                <Box>
                  <Typography variant="body1" paragraph>
                    A founding contributor ("Contributor") will be granted stock and/or membership units representing <strong>[___%]</strong> of the fully-diluted equity in both the C-Corporation and the IP Holding Company. This equity grant is not contingent on any separate capital contribution.
                  </Typography>
                  ...
                  <Typography variant="body1" paragraph>
                    The <strong>[___%]</strong> equity allocation shall vest over a 4-year period (48 months). The vesting rate will accelerate over time, rewarding sustained commitment.
                  </Typography>
                  ...
                  <Paper variant="outlined" sx={{ p: 2, mb: 2, bgcolor: 'grey.50' }}>
                    <Typography variant="body1" fontFamily="monospace">
                      Vested Equity = Total Equity Granted * ( (Days Worked - Cliff Days) / (Total Vesting Days - Cliff Days) )^2
                    </Typography>
                  </Paper>
                  <Typography variant="body1" paragraph>
                    This vesting formula is applicable only after the Contributor has successfully completed the initial <strong>6-month cliff period</strong>. If the Contributor leaves before this period, no equity will have vested.
                  </Typography>
                  ...
                  <Typography variant="body1" paragraph>
                    Below is an example of a <strong>25%</strong> equity grant vesting over <strong>4 years</strong> (1460 days), showing the accelerating growth of vested equity over time.
                  </Typography>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                      <thead>
                        <tr style={{ backgroundColor: '#f5f5f5' }}>
                          <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'left' }}>Time (Months)</th>
                          <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'left' }}>Days Worked</th>
                          <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'left' }}>Vested Equity</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[
                          ...
                          <tr key={index}>
                            <td style={{ padding: '8px', border: '1px solid #ddd' }}><strong>{row.months}</strong></td>
                  ...
                  <Typography variant="body1" paragraph>
                    If a Contributor's engagement ends before the 6-month cliff, no equity will have vested, and the entire equity grant will be returned to the Company. If a Contributor leaves after the 6-month cliff, they will retain all equity vested up to that point.
                  </Typography>
                </Box>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion expanded={expanded === 'deferred'} onChange={handleChange('deferred')}>
              ...
              <AccordionDetails>
                <Box>
                  ...
                  <Typography variant="body1" paragraph>
                    This deferred hourly wage begins accumulating upon signing and continues until the Company is able to negotiate a standard salary paid monthly. It shall be considered a debt on the balance sheet of the Company.
                  </Typography>
                  ...
                  <Typography variant="body1" paragraph>
                    Both the Founders and the Contributors shall be entitled to deferred wages at the rates below:
                  </Typography>
                  <List>
                    <ListItem>
                  ...
                  <Typography variant="body1" paragraph>
                    Accrued deferred wages shall be paid from monthly net income (as defined by GAAP accounting standards) on a pro-rata basis. The pro-rata share for each party shall be calculated as their total accrued deferred wages divided by the total accrued deferred wages of all parties.
                  </Typography>
                  ...
                  <Typography variant="body1" paragraph>
                    Both parties agree to maintain accurate time records in a shared digital log, as a spreadsheet with the following headings: Contributor Name, Date, Work Done, Hours, Rate ($/hr), Total.
                  </Typography>
                  ...
                  <Typography variant="body1" paragraph>
                    Any Founder or Contribute may dispute any log entry for another within 14 days. They must provide written reasoning and offer a way to remedy the dispute in order to earn those hours.
                  </Typography>
