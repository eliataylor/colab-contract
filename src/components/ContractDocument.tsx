...
const ContractDocument: React.FC = () => {
    ...
    return (
        <Box sx={{maxWidth: '800px', margin: '0 auto', padding: 3}}>
            ...
            <Typography variant="h4" component="h2" gutterBottom sx={{mt: 4, mb: 2}} color="primary">
            ...
            <Typography variant="h4" component="h2" gutterBottom sx={{mt: 4, mb: 2}} color="primary">
                <strong>The Twofold Principles of this Agreement</strong>
            </Typography>
            ...
            <Box component="ol" sx={{pl: 3, fontSize: '1.1rem', lineHeight: 1.6}}>
                ...
                <Typography component="li" paragraph>
                    <strong>Compensations:</strong> A. To grant each Contributor a transparent path to earning minority
            ...
            <Box sx={{
                ...
                {placeholders.CUSTOM_IP_DEFINITION}
            </Box>
            ...
            <Typography variant="h5" component="h3" gutterBottom sx={{mt: 3, mb: 2}} color="primary">
                <strong>Deferred Compensation</strong>
            </Typography>
