...
import {Business, Download, ExpandMore, MonetizationOn, Payment, Security, Timeline} from '@mui/icons-material';
    ...
    return (
        <Box sx={{margin: '0 auto', padding: 3}}>
            ...
            <div id="contract-content">
                ...
                <Typography variant="body1" paragraph sx={{fontSize: '1.1rem', lineHeight: 1.6}}>
                    Building a company is an act of shared creation. Our goal with this agreement is to transparently
                    define
                    the value we are creating together, ensuring fairness and security for every individual involved.
                    This
                    ...
                    <AccordionDetails>
                        ...
                        <Box component="ul" sx={{pl: 3, fontSize: '1.1rem', lineHeight: 1.6}}>
                            ...
                            <Typography component="li" paragraph>
                                ...
                                commitments, the
                                Founders reserve the right to work with the Contributor to re-evaluate their role,
                                vesting
                                schedule,
                                or engagement with the Company, ensuring that all parties are aligned and committed to
                                the
                                shared
                                goal.
                            </Typography>
                        ...
                        <Typography variant="body1" paragraph sx={{fontSize: '1.1rem', lineHeight: 1.6}}>
                            ...
                            However, to
                            protect the Founder's market positioning, the Contributor agrees that for a period
                            of <strong>twelve
                            (12) months</strong> following their departure from the Company, they will not, either
                            directly
                            or
