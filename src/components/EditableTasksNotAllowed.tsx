...
interface EditableTasksNotAllowedProps {
    value: string;
    onSave?: (newValue: string) => void;
}

const EditableTasksNotAllowed: React.FC<EditableTasksNotAllowedProps> = ({value, onSave}) => {
    ...
    const handleSave = () => {
        updateFounderData({tasksNotAllowed: editValue});
        if (onSave) {
            onSave(editValue);
        }
        setIsEditing(false);
            ...
            {isEditing ? (
                <Box>
                    <TextField
                        ...
                        placeholder="Enter tasks that do NOT qualify for deferred wages..."
                        rows={8}
                    />
                ...
                <Box sx={{
                    ...
                    <Tooltip title="Edit Tasks Not Allowed">
                        <IconButton
                            size="small"
                            onClick={handleEdit}
...
export default EditableTasksNotAllowed;
