...
const ContractPage: React.FC = () => {
  ...
  const { founderData, contributorData, timesheetEntries, totalDeferredWages, totalHoursWorked, averageHourlyRate } = useFormData();
  ...
  useEffect(() => {
    ...
    if (hash && ['principles', 'protections', 'compensations', 'vesting', 'deferred'].includes(hash)) {
    ...
    <PageContainer>
      <FadeIn>
              ...
              {timesheetEntries.length > 0 && (
                <Box>
                  ...
                  <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mb: 2 }}>
                    <Chip label={`Total Hours: ${totalHoursWorked}`} color="default" variant="outlined" />
                    <Chip label={`Total Deferred: $${totalDeferredWages.toFixed(2)}`} color="default" variant="outlined" />
                    <Chip label={`Avg Rate: $${averageHourlyRate.toFixed(2)}/hr`} color="default" variant="outlined" />
                  </Box>
        ...
        <StyledCard>
              ...
              <AccordionDetails>
                ...
                <Alert severity="info">
                  <Description variant="body2">
                    <strong>Excluded:</strong> Contributors' general skills, experience, and knowledge, 
                    as well as general software code, algorithms, and development methodologies that are 
                ...
                <Description>
                  For <strong>twelve (12) months</strong> following departure, Contributors agree not to:
                </Description>
                <List>
                  <ListItem>
                    <ListItemText primary="• Solicit employees or independent contractors to leave" />
                  </ListItem>
                  <ListItem>
                    <ListItemText primary="• Solicit customers for competitive services or products" />
                  </ListItem>
                </List>
                ...
                <Description>
                  For <strong>twelve (12) months</strong> following departure, Contributors agree not to use 
            ...
            {/* Compensations */}
            <Accordion 
              id="accordion-compensations"
              expanded={expanded.has('compensations')} 
              onChange={handleChange('compensations')}
            >
              <AccordionSummary expandIcon={<ExpandMore />}>
                <CardTitle variant="h6">
                  <AttachMoney /> 2. Compensations
                </CardTitle>
              </AccordionSummary>
              <AccordionDetails>
                <Description>
                  This section provides a clear and transparent path to earning equity and fair compensation 
            ...
            >
              ...
              <AccordionDetails>
                <Description>
                  ...
                  the IP Holding Company. This equity grant is not contingent on any separate capital contribution.
                </Description>
                ...
                <Card variant="outlined" sx={{ p: 2, mb: 2, bgcolor: 'grey.50' }}>
                  <Description fontFamily="monospace">
                    Vested Equity = Total Equity Granted × ((Days Worked - Cliff Days) / (Total Vesting Days - Cliff Days))²
                  </Description>
                </Card>

                <Alert severity="warning" sx={{ mb: 2 }}>
                  <Description variant="body2">
                    <strong>6-month cliff period:</strong> No equity vests before completing 180 days of work.
                  </Description>
                </Alert>
            ...
            >
              ...
              <AccordionDetails>
                ...
                <Alert severity="info" sx={{ my: 2 }}>
                  <Description variant="body2">
                    <strong>Example:</strong> Total Owed: $5,000 (Contributor) + $1,000 (Founder) = $6,000<br/>
                ...
                <Description>
                  ...
                  the following headings: Contributor Name, Date, Work Done, Hours, Rate ($/hr), Total.
                </Description>
